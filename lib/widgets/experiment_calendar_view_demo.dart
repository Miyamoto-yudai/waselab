...
/// デモ用実験予約カレンダービュー
class ExperimentCalendarViewDemo extends StatefulWidget {
  final Experiment experiment;
  final Function(DateTime, String) onSlotSelected;

  const ExperimentCalendarViewDemo({
    super.key,
  ...
  @override
  State<ExperimentCalendarViewDemo> createState() => _ExperimentCalendarViewDemoState();
}

class _ExperimentCalendarViewDemoState extends State<ExperimentCalendarViewDemo> {
            ...
            SizedBox(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final availability = _demoAvailability[slot] ?? 0;
