...
実験データは匿名化され、研究目的のみに使用されます。''';
            ...
            Card(
              ...
              child: Theme(
                ...
                child: ExpansionTile(
                  ...
                  title: Row(
                    children: [
                      const Icon(Icons.event, size: 20, color: Color(0xFF8E1728)),
                      const SizedBox(width: 8),
                      const Text('実施日時', style: TextStyle(fontWeight: FontWeight.bold)),
                      const SizedBox(width: 8),
                      Container(
                  ...
                  subtitle: _fixedExperimentDate != null || _fixedExperimentTime != null
                    ? Text(
                        '${_fixedExperimentDate != null ? '${_fixedExperimentDate!.year}/${_fixedExperimentDate!.month}/${_fixedExperimentDate!.day}' : '未設定'} ${_fixedExperimentTime != null ? '${_fixedExperimentTime!.hour.toString().padLeft(2, '0')}:${_fixedExperimentTime!.minute.toString().padLeft(2, '0')}' : ''}',
                        style: const TextStyle(fontSize: 13),
                      )
                    : const Text('特定の日時に実験を実施する場合', style: TextStyle(fontSize: 13)),
                  initiallyExpanded: _fixedDateExpanded,
                  onExpansionChanged: (expanded) {
                    setState(() {
                      _fixedDateExpanded = expanded;
                    });
                  },
                  children: [
                    Padding(
                                  ...
                                  child: InputDecorator(
                                    ...
                                    child: Text(
                                      _fixedExperimentDate != null
                                        ...
                                        : '日付を選択',
                                      style: TextStyle(
                                        color: _fixedExperimentDate != null ? null : Colors.grey.shade600,
                                      ),
                                    ),
                                  ),
                                ),
                                  ...
                                  child: InputDecorator(
                                    ...
                                    child: Text(
                                      _fixedExperimentTime != null
                                        ...
                                        : '時刻を選択',
                                      style: TextStyle(
                                        color: _fixedExperimentTime != null ? null : Colors.grey.shade600,
                                      ),
                                    ),
                                  ),
                                ),
            ...
            Card(
              ...
              child: Theme(
                ...
                child: ExpansionTile(
                  ...
                  title: Row(
                    children: [
                      const Icon(Icons.schedule, size: 20, color: Color(0xFF8E1728)),
                      const SizedBox(width: 8),
                  ...
                  subtitle: Text(
                    _reservationDeadlineController.text.isNotEmpty
                      ? '実施${_reservationDeadlineController.text}日前まで'
                      : 'デフォルト: 1日前',
                    style: const TextStyle(fontSize: 13),
                  ),
                  initiallyExpanded: _reservationDeadlineExpanded,
                  onExpansionChanged: (expanded) {
                    setState(() {
                      _reservationDeadlineExpanded = expanded;
                    });
                  },
                  children: [
                    Padding(
          ...
          Card(
            ...
            child: Theme(
              ...
              child: ExpansionTile(
                ...
                title: Row(
                  children: [
                    const Icon(Icons.check_circle, size: 20, color: Color(0xFF8E1728)),
                    const SizedBox(width: 8),
                ...
                subtitle: _requirements.isNotEmpty
                  ? Text(
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            const SizedBox(width: 8),
                            IconButton(
                              onPressed: _requirementController.text.trim().isNotEmpty ? _addRequirement : null,
          ...
          Card(
            ...
            child: Theme(
              ...
              child: ExpansionTile(
                ...
                title: Row(
                  children: [
                    const Icon(Icons.assignment_turned_in, size: 20, color: Color(0xFF8E1728)),
                    const SizedBox(width: 8),
                    const Text('特別な同意項目', style: TextStyle(fontWeight: FontWeight.bold)),
                    const SizedBox(width: 8),
                    Container(
                      padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 2),
                      decoration: BoxDecoration(
                ...
                subtitle: _consentItems.isNotEmpty
                  ? Text(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            const SizedBox(width: 8),
                            IconButton(
                              onPressed: _consentItemController.text.trim().isNotEmpty ? _addConsentItem : null,
                              icon: const Icon(Icons.add_circle),
                              color: const Color(0xFF8E1728),
                              iconSize: 32,
                            ),
            ...
            Card(
              ...
              child: Theme(
                ...
                child: ExpansionTile(
                  ...
                  title: Row(
                    children: [
                      const Icon(Icons.assignment, size: 20, color: Color(0xFF8E1728)),
                      const SizedBox(width: 8),
                      const Text('アンケート設定', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                      const SizedBox(width: 8),
                      Container(
                        padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 2),
                        decoration: BoxDecoration(
  ...
  /// AIアンケート生成ダイアログを表示
  Future<void> _showAiSurveyGenerator() async {
    // 現在入力されている実験情報を収集
    final experimentContext = {
      'title': _titleController.text.trim(),
      'description': _descriptionController.text.trim(),
      'detailedContent': _detailedContentController.text.trim(),
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                '入力された実験情報を元に、AIが最適なアンケートを生成します。',
                style: TextStyle(
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8),
                    if (experimentContext['title'] != '')
                      Text('• ${experimentContext['title']}', style: const TextStyle(fontSize: 12)),
                    if (experimentContext['type'] != null)
                      Text('• タイプ: ${experimentContext['type']}', style: const TextStyle(fontSize: 12)),
                    if (experimentContext['duration'] != '')
                      Text('• 所要時間: ${experimentContext['duration']}分', style: const TextStyle(fontSize: 12)),
                    if (_requirements.isNotEmpty)
                      Text('• 参加条件: ${_requirements.length}件', style: const TextStyle(fontSize: 12)),
                  ],
                ),
              ),
              const SizedBox(height: 24),
                ...
                children: [
                  ...
                  ElevatedButton.icon(
                    onPressed: () {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text('AIアンケート生成機能は現在開発中です'),
                        ),
                      );
                    },
                    icon: const Icon(Icons.auto_awesome),
                    label: const Text('生成を開始'),
                    style: ElevatedButton.styleFrom(
