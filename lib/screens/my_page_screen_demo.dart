...
import 'experiment_detail_screen_demo.dart';
                          ...
                          children: [
                            Expanded(
                              child: _buildActivityCard(
                                icon: Icons.campaign,
                                title: '募集中',
                                count: _demoCreatedExperiments.length,
                            ...
                            Expanded(
                              child: _buildActivityCard(
                                icon: Icons.science,
                                title: '参加予定',
                                count: _demoParticipatedExperiments.length,
                                color: Colors.blue,
                                onTap: () {
  ...
  Widget _buildExperimentHistoryTab(List<Experiment> experiments, String emptyMessage) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        final isMyExperiment = experiment.creatorId == 'current_user';
          ...
          child: InkWell(
            ...
            onTap: () {
              ...
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => ExperimentDetailScreenDemo(
